	...
	public Frame_stretch(Userinfo u) {
	    ...
	    jback.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				FrameBase.getInstance(new Frame_cross(u));
				f.dispose();
			}
		});
		...
		ex1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				// TODO Auto-generated method stub
				FrameBase.getInstance(new Frame_ExerciseInfo(u,exlist.get(0),7));
			}
		});
		...
		ex2.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				// TODO Auto-generated method stub
				FrameBase.getInstance(new Frame_ExerciseInfo(u,exlist.get(1),7));
			}
		});
		...
		ex3.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				// TODO Auto-generated method stub
				FrameBase.getInstance(new Frame_ExerciseInfo(u,exlist.get(2),7));
			}
		});
