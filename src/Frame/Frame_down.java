...
public class Frame_down extends JFrame{
	...
	public Frame_down(Userinfo u) {
		...
		ex1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				// TODO Auto-generated method stub
				FrameBase.getInstance(new Frame_ExerciseInfo(u,exlist.get(0),5));
			}
		});
		...
		ex2.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				// TODO Auto-generated method stub
				FrameBase.getInstance(new Frame_ExerciseInfo(u,exlist.get(1),5));
			}
		});
		...
		ex3.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				// TODO Auto-generated method stub
				FrameBase.getInstance(new Frame_ExerciseInfo(u,exlist.get(2),5));
			}
		});
